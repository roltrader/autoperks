-- ✅ FIXED VERSION: AutoPerks Database Schema (without JWT secret line)
-- This version removes the problematic JWT secret setting that causes permission errors
...
-- Technicians are readable by all authenticated users
